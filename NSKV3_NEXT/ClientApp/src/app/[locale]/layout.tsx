...
import { SiteSidebar } from "~/islands/navigation/site-sidebar";
...
export default async function LocaleLayout({
  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <body
        className={cn(
          "min-h-screen bg-background font-sans antialiased text-blue-900 dark:text-slate-400",
          fontHeading.variable,
          fontSans.variable,
        )}
      >
        <NextIntlProvider locale={locale} messages={messages}>
          <Script src="//code.jivo.ru/widget/U8eJrXc2af" />
