...
{
    public class DBService:ICategoriesService, IBaseService
    {
        private ODDANP _odp;
        private string error ;
        private string db_prefix = "db_nsk.";

        public DBService(ODDANP odp) 
        { 
            _odp = odp;
        }
        ...
        public IEnumerable<IDto> Index() 
        {
            ...
            var sql = SqlCommandBuilder.BuildSelectCommand<CategoryDTO>($"{db_prefix}categories", "is_active=1");
        ...
        public CategoryDTO? getCategoryItem(int id)
        {
            ...
            var sql = SqlCommandBuilder.BuildSelectCommand<CategoryDTO>($"{db_prefix}categories", $"is_active=1 and id={id}");
